    ...
    stages {
        ...
        stage('Deploy for production') {
            ...
            steps {
             ...
             snDevOpsArtifact(artifactsPayload:"""{"artifacts": [{"name": "prod_artifact.jar","version": "1.1","semanticVersion": "1.1.0","repositoryName": "Test"}],"stageName": "Deploy for production"}""")
                sleep 5
            }
        }
    }
