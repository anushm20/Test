    ...
    stages {
        ...
        stage('Deploy for development') {
            ...
            steps {
              ...
              sleep 10
             snDevOpsArtifact(artifactsPayload:"""{"artifacts": [{"name": "Artifact", "version": "1.${BUILD_NUMBER}", "semanticVersion": "1.${BUILD_NUMBER}.0","repositoryName": "Test"}],"stageName": "Deploy for development"}""")
